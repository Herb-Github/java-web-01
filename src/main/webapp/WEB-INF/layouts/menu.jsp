...
<div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
  <div class="am-offcanvas-bar admin-offcanvas-bar">
    <ul class="am-list admin-sidebar-list am-nav">
      ...
      <li>
        ...
        <ul class="am-list am-collapse admin-sidebar-sub ${menu=='user'?'am-in':''}" id="collapse-nav-user">
          <li class="${subMenu=='user'?'am-active':''}"><a href="${ctx}/user/" class="am-cf"><span
                  class="am-icon-users"></span> 用户<span
                  class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
          <li class="${subMenu=='role'?'am-active':''}"><a href="${ctx}/role/"><span class="am-icon-gear"></span> 角色</a>
          </li>
      ...
      <li class="${menu=='server'?'am-active':''}"><a href="${ctx}/server/"><span class="am-icon-server"></span> 机器</a>
      </li>
      <li class="${menu=='service'?'am-active':''}"><a href="${ctx}/service/"><span class="am-icon-table"></span> 服务</a>
      </li>
